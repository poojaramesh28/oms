...
<% for(Items i:list){  %>
  <tbody>
	...
	<td>
        <a type="button" class="btn  purple-gradient btn-rounded btn-sm m-0" href='SupplierListServlet?item_name=<%=i.getItem_name()%>&type_of_employee=employee&employee_id=<%=emp_id%>'>Show Suppliers</a>
      </td>
    </tr>
    <%} %>
   </tbody>
